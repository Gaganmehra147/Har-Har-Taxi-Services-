...
export default function ContactPage() {
  ...
  return (
    <>
            ...
            <div className="lg:col-span-6 space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="glass-panel p-6 rounded-2xl flex flex-col justify-between">
                  <div>
                    <div className="w-10 h-10 rounded-xl bg-zinc-200/80 dark:bg-zinc-800/50 text-zinc-700 dark:text-zinc-300 flex items-center justify-center mb-3">
                      <Phone className="w-5 h-5" />
                    </div>
                    <h3 className="text-sm font-bold text-zinc-950 dark:text-white font-display">Phone Helpline</h3>
                    <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1">Direct voice call for instant cab booking</p>
                  </div>
                  <div className="pt-4">
                    <a
                ...
                <div className="glass-panel p-6 rounded-2xl flex flex-col justify-between">
                  <div>
                    ...
                    <h3 className="text-sm font-bold text-zinc-950 dark:text-white font-display">WhatsApp Booking</h3>
                    <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1">Get fare quotes &amp; driver details</p>
                  </div>
                  <div className="pt-4">
                    <a
                      ...
                      className="block text-center py-2 px-3 rounded-lg text-xs font-bold bg-emerald-500 hover:bg-emerald-400 text-zinc-950 transition-colors"
                    >
                      Chat on WhatsApp
                    </a>
                  </div>
              ...
              <div className="glass-panel p-6 rounded-2xl space-y-4">
                <div className="flex items-start gap-3">
                  <MapPin className="w-5 h-5 text-zinc-700 dark:text-zinc-300 shrink-0 mt-1" />
                  <div>
                    <h3 className="text-sm font-bold text-zinc-950 dark:text-white font-display">Office Address (NAP)</h3>
                ...
                <div className="flex items-center gap-3 pt-2 border-t border-zinc-200 dark:border-zinc-800">
                  ...
                  <div>
                    ...
                    <span className="text-xs text-zinc-700 dark:text-zinc-200">{BUSINESS_CONFIG.email}</span>
                  </div>
                </div>

                <div className="flex items-center gap-3 pt-2 border-t border-zinc-200 dark:border-zinc-800">
                  <Clock className="w-4 h-4 text-zinc-700 dark:text-zinc-300 shrink-0" />
                  <div>
                    <span className="text-xs text-zinc-500 dark:text-zinc-400">Operating Hours: </span>
                    <span className="text-xs text-zinc-700 dark:text-zinc-200">{BUSINESS_CONFIG.businessHours}</span>
                  </div>
                </div>
                ...
                <div className="pt-3 border-t border-zinc-200 dark:border-zinc-800">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 text-xs font-semibold text-zinc-700 dark:text-zinc-300 hover:underline"
                  >
              ...
              <div className="glass-panel p-4 rounded-2xl">
                <div className="flex items-center justify-between mb-3 text-xs text-zinc-600 dark:text-zinc-300">
                  <span className="font-semibold flex items-center gap-1.5">
                    <MapPin className="w-3.5 h-3.5 text-zinc-700 dark:text-zinc-300" />
                    Jabalpur Base &bull; Geographic Coordinates
                  </span>
                  <span className="text-[11px] text-zinc-500 dark:text-zinc-400">23.1815° N, 79.9864° E</span>
                </div>
                <div className="w-full h-52 rounded-xl bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 flex flex-col items-center justify-center text-center p-4 relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-br from-zinc-200/60 via-zinc-100/40 to-zinc-200/60 dark:from-zinc-950/80 dark:via-zinc-900/60 dark:to-zinc-950/80" />
                  <div className="relative z-10 space-y-2">
                    <div className="w-12 h-12 rounded-full bg-zinc-200/80 dark:bg-zinc-800/50 border border-zinc-300 dark:border-zinc-700 text-zinc-700 dark:text-zinc-300 flex items-center justify-center mx-auto">
      ...
      <section className="py-16 bg-zinc-100 dark:bg-zinc-900/40 border-t border-zinc-200 dark:border-zinc-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-xl font-bold text-zinc-950 dark:text-white font-display mb-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 text-xs">
            {JABALPUR_LOCALITIES.map((loc) => (
              <div
                key={loc.name}
                className="p-3 rounded-xl bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 text-zinc-600 dark:text-zinc-300"
              >
                <div className="font-semibold text-zinc-950 dark:text-white mb-0.5">{loc.name}</div>
                <div className="text-[11px] text-zinc-500 dark:text-zinc-400 truncate">{loc.popularSpots.join(", ")}</div>
              </div>
            ))}
          </div>
        </div>
